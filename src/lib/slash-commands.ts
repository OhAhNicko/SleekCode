...
export const SLASH_COMMANDS: Partial<Record<string, SlashCommand[]>> = {
  ...
  gemini: [
    ...
    { name: "plan",           description: "Switch to Plan Mode (read-only) and view the current plan" },
    ...
    { name: "restore",        description: "Restore project files to state before a tool executed" },
