  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        jiraUnassignedMode: state.jiraUnassignedMode,
        jiraUnassignedTickets: state.jiraUnassignedTickets,
        jiraAssignedDoneTickets: state.jiraAssignedDoneTickets,
        jiraUnassignedProjects: state.jiraUnassignedProjects,
        jiraUnassignedNotify: state.jiraUnassignedNotify,
        jiraUnassignedSeen: state.jiraUnassignedSeen,
        jiraRailWidths: state.jiraRailWidths,
        jiraStatusIndicator: state.jiraStatusIndicator,
        ...
        jiraSitePriorities: state.jiraSitePriorities,
        jiraExtraFields: state.jiraExtraFields,
        ...
        verticalTabBarV2: state.verticalTabBarV2,
        verticalTabBarWidth: state.verticalTabBarWidth,
