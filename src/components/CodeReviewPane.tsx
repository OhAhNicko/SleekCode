        ...
        <div className="flex items-center gap-1">
          ...
          {isGitRepo && aheadBehind && !aheadBehind.hasRemote && (
            <button
              ...
              data-tooltip="Create a GitHub repository and push this project" aria-label="Create a GitHub repository and push this project"
            >
          ...
          {isGitRepo && aheadBehind?.hasRemote && (
            <button
              ...
              data-tooltip="Bump version, commit, tag, and push" aria-label="Bump version, commit, tag, and push"
            >
          ...
          {remoteUrl && (
            <button
              ...
              data-tooltip="Open issues on GitHub" aria-label="Open issues on GitHub"
            >
              <svg width="11" height="11" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <circle
                  cx="8"
