...
// `parse_hex_color` / `parse_theme` live in `super::super::theme_parse`.
// Originally defined here; consolidated into the shared module so all three
// platform backends pull from the same wire-format folder.
